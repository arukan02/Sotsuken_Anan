...
# %cd ../
!gdown --id 1gpOLc_2wBudY4fL3DtiC4Z0FOH7rhM8S
!unzip tomato.zip > /dev/null
...
catIds = coco.getCatIds(catNms=['tomato_flower']);
...
img_name = '/content/train2017/frame_000140.PNG'
...
img_name = '/content/val2017/frame_003160.PNG'
im = Image.open(img_name)
